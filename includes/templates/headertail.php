<header class="bg-[#A31A13] border-b-4 border-[#910000] px-6 py-4 fixed top-0 left-0 w-full z-10 transition-transform">
    <div class="flex flex-col justify-start items-start flex-nowrap gap-6 w-full h-auto lg:flex-row lg:justify-between lg:items-center">
        ...
        >
            <a href="/" class="text-white text-sm font-medium px-3 py-2 hover:text-[#e8241a] @apply whitespace-pre">Inicio</a>
